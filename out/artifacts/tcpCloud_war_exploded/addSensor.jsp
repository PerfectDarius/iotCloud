...
<body>
<form action="${pageContext.request.contextPath}/addSensor.action" method="post">
	<table border="1px" align="center" width="1000px" height="400px" cellpadding="0px" cellspacing="0px" style="background-color: #f7f8f8; margin-top: 36px;"  >
		...
		<tr>
			...
			<td style="padding-left: 5px;">
				<input type="text" name="sensor_ip" />
			</td>
		...
		<tr>
			...
			<td style="padding-left: 5px;">
				<input type="text" name="sensor_unit"  />
			</td>
		</tr>
